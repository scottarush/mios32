...
// S. Rush - This was set to 2 in the original release, but I think it should only be one
...
// Enables different (and working) velocity processing
...
#define KEYBOARD_SPLIT_MODE_OFF 0 
#define KEYBOARD_SPLIT_MODE_TWO 1
#define KEYBOARD_SPLIT_MODE_THREE 2
...
typedef struct {
  ...
  //  Scott Rush added parameters for split point
  // These are midi note numbers.
  u8 split_mode;
  u8 two_split_middle_note_number;
  s8 two_split_right_shift;
  u8 three_split_left_note_number;
  s8 three_split_left_shift;
  u8 three_split_right_note_number;
  s8 three_split_right_shift;

...
Studio 90 Plus Midibox
==============================================================================
Copyright (C) 2012 Thorsten Klose (tk@midibox.org)
and Copyright (C) 2024 Scott Rush
Licensed for personal non-commercial use only.
All other rights reserved.

Added by Scott Rush 2024:
This project modifies and extends Midibox_Kb_V1 for the Fatar Studio 90 Plus keyboard.
It also adds button scan, display, and extended preset support so that a stand-alone
Studio 90 Plus can directly recall presets from a dedicated MIDI sound module.
the entire controller can function as a "refurbished", Midibox-enabled Studio 90 Plus.
===============================================================================
...
Connection Plan for Studio 90 Plus (added by Scott Rush)

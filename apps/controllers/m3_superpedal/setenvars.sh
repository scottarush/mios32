export PATH=$PATH:/usr/lib/gnutools/gnu-tools-for-stm32-12.3.rel1/install-native/bin
export MIOS32_PATH=~/midibox/mios32
export MIOS32_BIN_PATH=/usr/lib/mios32_toochain/bin

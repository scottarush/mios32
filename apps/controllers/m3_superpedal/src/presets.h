...
#define PRESETS_ADDR_KB1_SPLIT_MODE             (0xd8 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xd8
#define PRESETS_ADDR_KB1_TWO_SPLIT_NN           (0xd9 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xd9
#define PRESETS_ADDR_KB1_TWO_SPLIT_RIGHT_SHIFT  (0xda + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xda
#define PRESETS_ADDR_KB1_THREE_SPLIT_LEFT_NN    (0xdb + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xdb
#define PRESETS_ADDR_KB1_THREE_SPLIT_LEFT_SHIFT (0xdc + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xdc
#define PRESETS_ADDR_KB1_THREE_SPLIT_RIGHT_NN   (0xdd + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xdd
#define PRESETS_ADDR_KB1_THREE_SPLIT_RIGHT_SHIFT (0xde + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xde
...
#define PRESETS_ADDR_KB2_SPLIT_MODE             (0xd8 + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xf8
#define PRESETS_ADDR_KB2_TWO_SPLIT_NN          (0xd9 + 1*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xf9
#define PRESETS_ADDR_KB2_TWO_SPLIT_RIGHT_SHIFT  (0xda + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xfa
#define PRESETS_ADDR_KB2_THREE_SPLIT_LEFT_NN    (0xdb + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xfb
#define PRESETS_ADDR_KB2_THREE_SPLIT_LEFT_SHIFT (0xdc + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xfc
#define PRESETS_ADDR_KB2_THREE_SPLIT_RIGHT_NN   (0xdd + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xfd
#define PRESETS_ADDR_KB2_THREE_SPLIT_RIGHT_SHIFT (0xde + 0*PRESETS_OFFSET_BETWEEN_KB_RECORDS) // 0xfe
